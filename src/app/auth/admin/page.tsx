        ...
        <div className="min-h-screen bg-transparent relative flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 flex flex-col items-center">
                ...
                <p className="mt-2 text-center text-sm text-muted-foreground">
                    Connectez-vous pour gérer votre département
                </p>
            </div>
            ...
            >
                <div className="bg-card py-8 px-4 shadow-xl shadow-black/5 sm:rounded-2xl border border-border sm:px-10">
                    <div className="space-y-5">
                        <div>
                            <label className="block text-sm font-medium text-foreground mb-1.5">Email institutionnel</label>
                        ...
                        <div>
                            <Link href="/dashboard">
                                <Button className="w-full flex justify-center items-center gap-2 py-2.5 bg-accent text-accent-foreground hover:bg-accent/90 rounded-lg font-medium shadow-sm shadow-accent/20">
                                    Connexion Admin <ArrowRight className="h-4 w-4" />
                                </Button>
                            </Link>
                        </div>
                    </div>
